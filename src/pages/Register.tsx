...
export function Register() {
  ...
  const getFriendlyErrorMessage = (errMsg: string) => {
    if (errMsg.includes('UNIQUE constraint failed: users.id')) {
    ...
    <div className="max-w-md mx-auto mt-16">
      <div className="bg-white dark:bg-slate-800 p-8 rounded-xl shadow-sm border border-slate-100 dark:border-slate-700">
        <div className="text-center mb-8">
          <div className="w-16 h-16 bg-yellow-500 rounded-xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-yellow-500/30">
